            ...
            match message {
                ...
                ServerMessage::UserNotice(usernotice) => match usernotice.event {
                    ...
                    UserNoticeEvent::GiftPaidUpgrade {
                        ...
                        format!("{} continued their gifted sub from {}!", usernotice.sender.name, gifter_name)
                    }

                    UserNoticeEvent::AnonGiftPaidUpgrade {
                        promotion
                    } => {
                        format!("{} continued their gifted sub from an anonymous user!", usernotice.sender.name)
                    }
                    ...
                    UserNoticeEvent::BitsBadgeTier {
                        ...
                        format!("{} just earned the {} bits badge!", usernotice.sender.name, threshold)
                    }
